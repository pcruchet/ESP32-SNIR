...
void Coffre::Fermer() {
    ...
    laSerrure.Verrouiller(); // Commande led D1 pour allumage
    laSerrure.Bloquer();   // Commande servo pour bloquage
    etat = FERME;
...
void Coffre::Ouvrir() {
    ...
    laSerrure.Deverrouiller();  // Commande led D1 pour extinction
    laSerrure.Debloquer();   // Commande servo pour débloquage
    etat = OUVERT;
    PurgerCode();  // Effacer code
}